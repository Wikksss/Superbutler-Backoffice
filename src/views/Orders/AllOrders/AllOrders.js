  ...
  constructor(props) {
    ...
    if (userObj.Enterprise.EnterpriseTypeId != 15) {
      ...
      onMessage(messaging, (payload) => {
        ...
        this.Refresh();
        let temp = payload;
        let title = temp.notification.title;
          ...
          { isSupermealDelivery && orderStatus > 0 ? '' :
            <Dropdown.Menu>
              <div className="menu-data-action-btn-wrap">
                <Dropdown.Item > {<span className="m-b-0 statusChangeLink m-r-20 " onClick={() => this.StatusModal(restId, orderId, orderStatus, type,isSupermealDelivery)}>
...
printView = (token) => {
  ...
  toggleStatusModal = () => {
    this.setState({ moveToStatus: !this.state.moveToStatus
 ...
 SendPushyNotification = () => {
  ...
  handleChangeCheckbox = (e) =>{
    this.setState({ progressbarCheckbox: e.target.checked })
    this.PlayAndStopProgressbar()
  }
        ...
        <div className="all-order-drop-down  card-new-title mb-2">
         ...
         <select className="order-date-dropdown form-control custom-select d-none" value={this.state.SelectedDuration} style={{ height: '36px' }} onChange={(e) => this.HandleChangeDuration(e.target.value)}>
              ...
              {(this.state.userObj.Enterprise.EnterpriseTypeId == 1 || this.state.userObj.Enterprise.EnterpriseTypeId == 2) &&
                ...
                <div className='custom-r-select-dd '>
              ...
              {/* <span
                className={`d-flex align-items-center ml-2 ${this.state.activeTab === "allOrders" ? "active btn btn-primary" : " add-cat-btn"}`}
          ...
          <div className="card-body" style={{ display: this.state.activeTab === "allOrders" ? "block" : "none" }}>
  ...
  <li onClick={(e) => this.GetOrdersByStatus(this.state.EnterpriseOrders, 6)}><button className={this.state.SelectedStatus === 6 ? "button-link active" : "button-link"}>Booking<Badge color="info">{this.GetOrdersCount(this.state.EnterpriseOrders, 6)}</Badge></button></li> */}
            ...
            <ProgressBar now={this.state.ProgressWidth} />
             <a className={this.state.IsStopped ? "pause-btn active" : "pause-btn"} onClick={() => this.PlayAndStopProgressbar()} >
               <span><i className="fa fa-stop" aria-hidden="true"></i></span>
                ...
                <input type="checkbox" className="form-checkbox refresh-chk-box" onChange={(e) => { this.handleChangeCheckbox(e) }} name="progressbarCheckbox" id="progressbarCheckbox" checked={this.state.progressbarCheckbox} value={this.state.progressbarCheckbox} />
          ...
          <div className="kds-main-p" style={{ display: this.state.activeTab === "kds" ? "block" : "none" }}>
            <div className='kds-main-inner'>
              <div className="kds-col">
                <span className="kds-label">
                  New
                </span>
                <div className="kds-top">
                  <div className="kds-hdr" style={{background:"#f2f2f2"}}>
                    <div className="kds-f-row">
                      <span>#232286</span>
                      <span>Dine-in</span>
                    </div>
                    <div className="kds-f-row">
                      <span>Room-no 21</span>
                  ...
                  <div className="kds-order-info">
                    <div className="kds-info-row">
                      <span className="kds-o-label">1 x Kashmiri - 100gm</span>
                      <span className="kds-o-label-r">400.00</span>
                    </div>
                    <div
                      className="kds-expdand-col"
                      ref={this.contentRef}
                      style={{
                        maxHeight: this.state.isExpanded ? `${this.contentRef.current?.scrollHeight}px` : "0px",
                        overflow: "hidden",
                      }}
                    >
                    <div className="kds-info-row">
                    ...
                    <div className="kds-info-row">
                      ...
                      <span className="kds-o-label-r">$80.00</span>
                    </div>
                    <div className="kds-info-row">
                      <span className="kds-o-label bold">Total Payable:</span>
                      <span className="kds-o-label-r bold">$ 472.00</span>
                    </div>
                    <div className="kds-info-row">
                      <span className="kds-o-label">Payment mode</span>
                      <span className="kds-o-label-r">Post to Room</span>
                    </div>
                    </div>
                    <span className="cursor-pointer text-primary kds-expand font-16 d-flex justify-content-end align-items-center mt-1" onClick={this.toggleExpand}>
                    {this.state.isExpanded ? <FaCompressAlt /> : <FaExpandAlt />}
                    </span>
                  </div>
                </div>
                <div className="kds-top">
              ...
              <div className="kds-col">
                ...
                <div className="kds-top">
                  <div className="kds-hdr" style={{background:"#e1f7ff"}}>
                    <div className="kds-f-row">
                      <span>#232286</span>
                      <span>Dine-in</span>
                    </div>
              ...
              <div className="kds-col">
                ...
                <div className="kds-top">
                  <div className="kds-hdr" style={{background:"#fff1cf"}}>
                    <div className="kds-f-row">
                      <span>#232286</span>
                      <span>Dine-in</span>
                    </div>
              ...
              <div className="kds-col">
                ...
                <div className="kds-top">
                  <div className="kds-hdr" style={{background:"#d5ffbd"}}>
                    <div className="kds-f-row">
                      <span>#232286</span>
                      <span>Dine-in</span>
                    </div>
