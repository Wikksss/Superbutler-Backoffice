      ...
      customBodyRender: (value, tableMeta, updateValue) => {
        return (
          <div style={{ width: 20 }}>
            ...
            <span id="removeTooltip" title="remove" onClick={()=>this.DeleteSaleConfirmation(this.state.enterpriseGroups[tableMeta.currentTableData[tableMeta.rowIndex].index])} className='icon-bg-h  cursor-pointer '>
              <i className="fa fa-trash font-13" aria-hidden="true"></i>
    ...
    return (
      ...
      <div>
        ...
        <div className={this.state.scrolled ? ' sub-h fixed-sub-header d-flex align-items-center' : 'sub-h d-flex align-items-center group-edit-res'} >
                  <div className='d-flex w-100 justify-content-between flex-wrap mb-4'>
                    <div className='d-flex align-items-center header-res-m'>
                      ...
                      <div className="" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <h3 className="card-title ">Edit Groups</h3>
                      </div>
                    </div>
          ...
          <div className='card'>
            ...
            <AvForm>
              ...
              <div className='min-height-table position-relative'>
                ...
                <h3>Business in this group</h3>
                <button className='btn btn-primary' onClick={() => this.AddToGroupModal()}>Add to group</button>
                </div>
        ...
        {/* Modal starts here  */}
        <Modal isOpen={this.state.AddToGroup} toggle={() => this.AddToGroupModal()} className={this.props.className}>
          <ModalHeader toggle={() => this.AddToGroupModal()} >Business</ModalHeader>
          ...
          <FormGroup className="modal-footer" >
            ...
            <div>
              <Button className='mr-2 text-dark' color="secondary" onClick={() => this.AddToGroupModal()}>cancel</Button>
