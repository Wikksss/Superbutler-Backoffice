...
SetPaymentMode = (paymentModes, status, payableAmount) => {
  ...
  render() {
   ...
   <div className="print">
    ...
    <div className='luggage-print-rec-wrap d-none'>
          <div className='luggage-logo'>

          <div className='d-flex justify-content-between mb-2'>
    <a className="btn btn-primary hidden-print text-white w-100 mr-2" style={{marginTop:'0px'}} target="_blank" onClick={() => this.customerCopy(true)}>
    <i className="fa fa-print mr-2"> </i>
    Customer Copy  
  </a>

  <a className="btn btn-success hidden-print text-white w-100" style={{marginTop:'0px'}} target="_blank" onClick={() => this.customerCopy(false)}>
    <i className="fa fa-print mr-2"> </i>
    Print Bag Tag
  </a>
  </div>
        ...
        { this.state.customerCopy ? 
          ...
          :
              ...
              <div className='luggage-info-sec'>
                ...
                <div className='luggage-info-sec-i mb-2' style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10}}>
                  ...
                  <div className='text-center'>
                    ...
                    <span className='font-14 w-100 d-block poppins-medium'>{Utilities.getDateByZone(order.OrderPlaceDate, "DD-MMM-YYYY", timeZone)}</span>
                  </div>
                  <div className='text-center'>
                    <span className='font-12 w-100 d-block'>Collected by </span>
                    <span className='font-14 w-100 d-block poppins-medium'>{this.state.userObj.FirstName}</span>
                  </div>
                  <div>
                    <span className='font-12 w-100 d-block'>No. of Bags</span>  
                    <span className='font-14 w-100 d-block poppins-medium text-center' style={{maxWidth:60}}>{this.state.NoOfBags.padStart(2, '0')}</span>
                  </div>
                  <div className='text-center'>
                    <span className='font-12 w-100 d-block'>No. of Days</span>
                    <span className='font-14 w-100 d-block poppins-medium'>{}</span>
                  </div>
                </div>
                <div style={{ marginBottom: 15 }}>
                  <span className='font-12 w-100 d-block'>INSTRUCTIONS</span>
                  <span className='font-14 w-100 d-block poppins-medium'>Handle with care</span>
                </div>
              </div>
              ...
              <div className='lugg-info-id d-flex align-items-center justify-content-around'>
                ...
                <span className='claim-id font-24 bold w-100 d-block poppins-bold'>121683</span>
                </div>
                <div className='lugg-info-id-i'>
                <span className='claim-id d-block font-13 poppins-medium w-100'>Bag Numbers</span>
                <span className='claim-id font-24 w-100 d-block poppins-medium'>01 of 03</span>
                </div>
              </div>
