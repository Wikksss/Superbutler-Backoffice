...
const   MewsBody =  "{\r\n  \"ClientToken\": \"51FCFA70833D442FB0B1B1BF014BF0EF-5BECC2C7D47F9452473818492BE9303\",\r\n  \"AccessToken\": \"0EA1BCF27D924F1CBEF9B1BF014E0D50-821A8DD55B1F85A5EBB4DDBCE1970A2\",\r\n  \"Client\": \"SuperButlerV1.0\"\r\n}"
...
Resources = async(url) => {
  ...
  params.ResourceIds = ["54253932-9bd1-4cb8-a050-b046007329de"];
  params.Limitation= { "Count": 100}
  let response = await PMSService.MewsPost(url, params);
  this.setState({response: response, requestURL: url, ApiCall: true, payload: params, showLoader: false});
  //this.saveToFile(response);
}
...
// saveToFile = async (response) => {
//   //return;
//   const { responseText, filename } = this.state;
...
//     alert('File saved successfully in the file system');
//   } catch (error) {
        ...
        <div className="card-body">
          <div className='row'>
            ...
            <div className='d-inline-flex flex-column mt-3' style={{gap:"15px"}}>
              ...
              <span className="btn btn-primary" onClick={() => this.Resources(mewsBaseUrl + "/resources/getAll")}>Resources</span>
